              ...
              <div className="row justify-content-center">
                  <div className="col-lg-8">
                      ...
                      <div className="mil-center mil-mb-120">
                          ...
                          <p className="mil-text-lg mil-up">Atha Constructions we are a leader in architecture and design with a user-centric approach and deep technical expertise. We are consistently ranked as one of the top architecture firms in the Banglore, and our core disciplines are supported by a wide range of complementary services, all of which have a singular goal: to build environments where our clients thrive.</p>
                      </div>
